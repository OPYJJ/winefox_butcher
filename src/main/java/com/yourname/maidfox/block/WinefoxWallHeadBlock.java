...
public class WinefoxWallHeadBlock
extends WallSkullBlock {
    public WinefoxWallHeadBlock() {
        super((SkullBlock.Type)SkullBlock.Types.PLAYER, BlockBehaviour.Properties.copy((BlockBehaviour)Blocks.PLAYER_WALL_HEAD));
    }
